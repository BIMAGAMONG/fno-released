...
class GJClient {
     ...
     * and you will be able to log in again with other user's GUI, but if you just wanna log out without erase your GUI from the application, use `logout()` instead.
